...
public class invalidColorStatus extends BaseTest
{
	String testCaseName="invalidColorStatus";
	Xls_Reader xls;
	@Test(dataProvider="getData")
	public void invalidColorStatusTest(Hashtable<String,String> data) throws IOException
	{
        check=1;
		test = rep.startTest("invalidColorStatusTest");
		...
		infoByColor(data.get("ParkingSlotName"),data.get("wrongcolor"));
