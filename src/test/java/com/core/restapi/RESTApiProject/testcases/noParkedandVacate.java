...
public class noParkedandVacate extends BaseTest
{
	String testCaseName="noParkedandVacate";
	Xls_Reader xls;
	@Test(dataProvider="getData")
	public void noParkedandVacateTest(Hashtable<String,String> data) throws IOException
	{
        check=1;
		test = rep.startTest("noParkedandVacateTest");
