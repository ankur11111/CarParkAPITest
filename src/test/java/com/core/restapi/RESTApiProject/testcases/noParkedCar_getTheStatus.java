...
public class noParkedCar_getTheStatus extends BaseTest
{
	String testCaseName="noParkedCar_getTheStatus";
	Xls_Reader xls;
	@Test(dataProvider="getData")
	public void noParkedCar_getTheStatusTest(Hashtable<String,String> data) throws IOException
	{
        check=1;
		test = rep.startTest("noParkedCar_getTheStatusTest");
